...
def mock_db():
    ...
    with (
        patch("coaching_mcp.tools.get_rep_insights.fetch_one") as mock_fetch_one,
...
class TestGetRepInsightsTool:
    ...
    def test_get_rep_insights_last_7_days(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(rep_email="sarah@example.com", time_period="last_7_days")
    ...
    def test_get_rep_insights_last_30_days(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(rep_email="sarah@example.com", time_period="last_30_days")
    ...
    def test_get_rep_insights_last_quarter(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(rep_email="sarah@example.com", time_period="last_quarter")
    ...
    def test_get_rep_insights_all_time(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(rep_email="sarah@example.com", time_period="all_time")
    ...
    def test_get_rep_insights_with_product_filter(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(rep_email="sarah@example.com", product_filter="prefect")
    ...
    def test_get_rep_insights_score_trends(
        self, mock_db, sample_rep_data, sample_coaching_sessions
    ):
    ...
    def test_get_rep_insights_multiple_filters(self, mock_db, sample_rep_data):
        ...
        result = get_rep_insights_tool(
            rep_email="sarah@example.com", time_period="last_quarter", product_filter="horizon"
        )
