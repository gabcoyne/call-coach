  ...
  describe('Custom Styling', () => {
    ...
    it('should accept and merge custom className', () => {
      const { container } = render(
        <ScoreBadge score={85} className="custom-class" />
      )
...
describe('DimensionScoreCard', () => {
  describe('Rendering', () => {
    ...
    it('should not render description when not provided', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={85} />
      )
  ...
  describe('Progress Bar', () => {
    ...
    it('should render progress bar with correct width', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={75} />
      )
    ...
    it('should apply green color for scores >= 90%', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={95} />
      )
    ...
    it('should apply blue color for scores 75-89%', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={80} />
      )
    ...
    it('should apply orange color for scores 60-74%', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={65} />
      )
    ...
    it('should apply red color for scores < 60%', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={50} />
      )
  ...
  describe('Edge Cases', () => {
    it('should handle 0% score', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={0} />
      )
      const progressBar = container.querySelector('[style*="width"]')
    ...
    it('should handle 100% score', () => {
      const { container } = render(
        <DimensionScoreCard dimension="Discovery" score={100} />
      )
      const progressBar = container.querySelector('[style*="width"]')
